...
class TicketBuyer:
    ...
    service = Service(executable_path="D:\\browserdriver\\CD135\\chromedriver.exe")
    ...
    def confirm_passenger(self):
        ...
        self.wait.until(
            excon.element_to_be_clickable((By.XPATH, '//a[@id="submitOrder_id"]'))
        ).click()
        #
